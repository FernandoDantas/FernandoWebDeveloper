...
class Email {
    ...
    public function Enviar(array $Data) {
        ...
        if (in_array('', $this->Data)):
            $this->Error = ['Erro ao enviar mensagem: Para enviar esse e-mail. Preencha os campos requisitados!', FWD_ALERT];
            $this->Result = false;
        elseif (!Check::Email($this->Data['RemetenteEmail'])):
            $this->Error = ['Erro ao enviar mensagem: O e-mail que você informou não tem um formato válido. Informe seu E-mail!', FWD_ALERT];
            $this->Result = false;
        else:
            $this->setMail();
            $this->Config();
    ...
    private function setMail() {
        ...
        $this->Data = null;
        $this->setMsg();//Para criar um html com a cara do sistema é dentro deste metodo
    }
