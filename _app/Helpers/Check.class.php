...
class Check {
    ...
    public static function CatByName($CategoryName) {
        $read = new Read;
        $read->ExeRead('fwd_categories', "WHERE category_name = :name", "name={$CategoryName}");
        if ($read->getRowCount()):
    ...
    public static function UserOnline() {
        ...
        $deleteUserOnline->ExeDelete('fwd_siteviews_online', "WHERE online_endview < :now", "now={$now}");

        $readUserOnline = new Read;
        $readUserOnline->ExeRead('fwd_siteviews_online');
