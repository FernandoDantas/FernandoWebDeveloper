    ...
    <body class="painel">
        ...
        <header id="navadmin">
            <div class="content">
                ...
                <h1 class="logomarca">Fernand Web Developer</h1>
        ...
        <div id="painel">
            ...
            if (file_exists($includepatch)):
                ...
                FWDErro("<b>Erro ao incluir tela:</b> Erro ao incluir o controller /{$getexe}.php!", FWD_ERROR);
                echo "</div>";
            endif;
            ?>
        </div> <!-- painel -->
        ...
        <footer class="main_footer">
            <a href="http://www.fernandowebdeveloper.com.br" target="_blank" title="Fernando Dantas">&copy; Fernando Dantas - Todos os Direitos Reservados</a>
        </footer>
